...
<html lang="en">
	...
	<body style="background-color: hsla(20, 50%, 98%, 0.733);">
		...
		<div id="page-container" class="container mt-2">
			<div class="row justify-content-center">
				...
				<div class="col-5 text-center border-right border-light pt-1 px-5">
					<img alt="" src="show_restaurant_logo.do?logo=${restaurant.picPath}" id="restaurant_logo" height="200">
				...
				<div class="col-6 p-0 m-0">
					...
					<form action="restaurant_profile.do" method="post" class="w-75 ml-3" id="profile_form">

						<div class="form-group">
							<label for="id_name">Restaurant Name</label>
							<input type="text" name="name" id="id_name" value="${restaurant.name}"
								class="form-control">
						...
						<div class="form-group">
							...
							<textarea rows="3" name="address" id="id_address"
								class="form-control" minlength="10">${restaurant.address}</textarea>
							<small id="address_help" class="form-text text-muted pl-1">Enter valid
								address.</small>
							<small id="address_error" class="form-text text-danger pl-1 hide">Invalid
								address. Please enter valid address.</small>
						</div>
						...
						<div class="form-group">
							...
							<select class="form-control" name="city" id="id_city">
								...
								<% for(City city : cities){
									if(city.getCityId()==restaurant.getCity().getCityId()){ %>
						...
						<div class="form-group">
							...
							id="id_contact" class="form-control" minlength="10" maxlength="10"
							autocomplete="off" style="width: 75% ; display: inline;">
						...
						<input type="submit" id="id_savedetails" class="btn btn-primary mt-2 mb-5" value="Save Details">
					</form>
				</div>
			</div>
		</div>
		...
		<script>
			...
			let dropzone = new Dropzone('#picupload', { url: 'restaurant_logo_upload.do' });

			let btn = document.querySelector('#btn');
			btn.addEventListener('click', () => {
				dropzone.processQueue();
				document.querySelector('#restaurant_logo').style.display = 'none'; 
			});
