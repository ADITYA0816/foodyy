...
<html lang="en">
	<head>
		...
		<title>Deliverer : All Undelivered Orders</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-11 ml-0" id="body_menu">
					<h4 class="text-primary" style="margin-left: 17px">Undelivered Orders :</h4>
					
					<% 
						ArrayList<OrderedFood> allUndeliveredOrders = (ArrayList<OrderedFood>)request.getAttribute("allUndeliveredOrders"); 
						OrderedFood orderedFood = new OrderedFood();
					%>
					
					<div class="card-group">
						
						<% for(OrderedFood order : allUndeliveredOrders){ %>
	      						...
	      						<div class="card p-1">
									<div class="row my-1">
		      						...
		      						<div class="card-body ml-2">
		      							...
		      							<h6 class="mb-0 mt-2">Delivery: </h6>
		      							...
		      							<span class="d-block small" style="font-size: 90% ;">Expected Delivery Time : <%= order.getOrder().getExpectedDeliveryTime() %></span>
		      							<span class="d-block small" style="font-size: 90% ;">Order Total : Rs.<%= order.getOrder().getOrderTotal() %></span>
		      						</div>
		      						
		      						<div class="py-2 px-4">
	      								<button id="id_<%= order.getOrder().getOrderId() %>" class="btn btn-sm btn-success float-right" onClick="delivered(this.id)">Delivered</button>
	      							</div>
	      						</div>
	      					</div>      					
	      				<% } %>      				
