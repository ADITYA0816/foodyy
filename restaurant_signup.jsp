...
<body style="background-color: hsla(20, 50%, 98%, 0.733);">
        ...
        <div class="row justify-content-center">
            <div class="col-6 p-0 m-0">
                ...
                <div class="">
                    ...
                    <h6 style="font-size: 12px;">or <a href="restaurant_signin.do" class="sublink">Sign In to your
                            account</a></h6>
                </div>
                ...
                <form action="restaurant_signup.do" method="post" class=" mt-3">

                    <input type="text" id="id_uname" value="${param.name}" class="form-control" name="name"
                        placeholder="Restaurant Name" minlength="5" maxlength="20" autocomplete="off">
                    ...
                    <input type="password" id="id_password" class="form-control d-inline-block"
                        style="width: 95%;" name="password" placeholder="Password" minlength="6"
                        maxlength="16"><i id="view_password" class="fa fa-eye float-right mt-3 pl-0"
                        aria-hidden="true"></i>
    ...
    <script src="static/js/restaurant_signup.js"></script>
