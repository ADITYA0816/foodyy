...
<html lang="en">
	<head>
		...
		<title>Deliverer : All Orders</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-11 ml-0" id="body_menu">
					<h4 class="text-primary" style="margin-left: 17px">All Processed Orders :</h4>
					
					<% 
						ArrayList<OrderedFood> allProcessedOrders = (ArrayList<OrderedFood>)request.getAttribute("allProcessedOrders"); 
						OrderedFood orderedFood = new OrderedFood();
					%>
					
					<div class="card-group">
						
						<% for(OrderedFood order : allProcessedOrders){ %>
			          		...
			          		<div id="card_<%= order.getOrder().getOrderId() %>" class="col-4 mt-2">
	      						<div class="card p-1">
									<div class="row my-1">
		      						...
		      						<div class="py-2 px-4">
	      								<button id="id_<%= order.getOrder().getOrderId() %>" class="btn btn-sm btn-success float-right" onClick="acceptOrderDelivery(this.id)">Accept</button>
	      							</div>
	      						</div>
	      					</div>
