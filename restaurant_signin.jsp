...
<body style="background-color: hsla(20, 50%, 98%, 0.733);">
        ...
        <div class="row justify-content-center">
            <div class="col-6 p-0 m-0">
                ...
                <div class="">
                    ...
                    <h6 style="font-size: 12px;">or <a href="restaurant_signup.do" class="sublink">Create your
                            account</a></h6>
                </div>
                ...
                <form action="restaurant_signin.do" method="post" class="mt-3">
                    ...
                    <input type="submit" class="btn btn-danger mt-2 self-left" value="Sign In">
    ...
    <script src="static/js/restaurant_signin.js"></script>
</body>
